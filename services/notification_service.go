...
func NewNotificationManager(emailService EmailService, slackService SlackService, inAppService InAppService, scheduler SchedulerService) *NotificationManager {
